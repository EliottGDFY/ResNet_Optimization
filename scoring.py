...
def is_model_quantized(model):
    return torch.backends.quantized.engine is not None

def main():
    # Resnet34 - Reference for CIFAR 10
    ref_params = 11173962
    ref_flops  = 1112074240
    # WideResnet-28-10 - Reference for CIFAR 100
    # ref_params = 36500000
    # ref_flops  = 10490000000

    
    model=resnet.ResNet18_fact()

    '''
    model =torch.load("ResNet34/ResNet34_net.pth")
    #model.to(device)
    '''
